import{_ as b}from"./AppSelect-CchSVBLF.js";import{c as D,a as I,b as B}from"./avatar-5-Di8vAcaH.js";import{V as w}from"./VChip-B_cIAknm.js";import{V as O}from"./VAvatar-DbhDskYx.js";import{r as f,o as p,f as d,e as a,b as e,d as s,t as x,aB as v,k as S,q as i}from"./index-cgm6LFIY.js";import{a as r,V as A}from"./VRow-6SHQ03nK.js";import{V}from"./VSelect-CXIfMPLy.js";import{_ as k}from"./AppCardCode-BeQaqLA7.js";import"./VTextField-CP9m34WE.js";import"./autofocus-ClcHqHKL.js";import"./VCounter-DUuKQBE5.js";import"./VField-D6Bz1Gxp.js";import"./VList-Dv5FMTTV.js";import"./VListSubheader-HZgUvJHu.js";import"./VDivider-DEOz8ltv.js";import"./VCheckboxBtn-7exKumXA.js";import"./VSelectionControl-jd6KPVBF.js";import"./vue3-perfect-scrollbar-Dc5wlA6J.js";import"./VCard-B1QYoICK.js";import"./VCardText-uZLr2B-Z.js";const y="/assets/avatar-1-DMk2FF1-.png",G="/assets/avatar-2-D5OQ4OGs.png",$={__name:"DemoSelectSelectionSlot",setup(u){const l=[{name:"Sandra Adams",avatar:y},{name:"Ali Connors",avatar:G},{name:"Trevor Hansen",avatar:D},{name:"Tucker Smith",avatar:I},{name:"Britta Holt",avatar:B}],t=f(["Sandra Adams"]);return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(t),"onUpdate:modelValue":o[0]||(o[0]=n=>v(t)?t.value=n:null),items:l,"item-title":"name","item-value":"name",label:"Select Item",placeholder:"Select Item",multiple:"",clearable:"","clear-icon":"tabler-x"},{selection:a(({item:n})=>[e(w,null,{prepend:a(()=>[e(O,{start:"",image:n.raw.avatar},null,8,["image"])]),default:a(()=>[s("span",null,x(n.title),1)]),_:2},1024)]),_:1},8,["modelValue"])}}},N={__name:"DemoSelectMultiple",setup(u){const l=f(["Alabama"]),t=["Alabama","Alaska","American Samoa","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","District of Columbia","Federated States of Micronesia","Florida","Georgia","Guam"];return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(l),"onUpdate:modelValue":o[0]||(o[0]=n=>v(l)?l.value=n:null),items:t,"menu-props":{maxHeight:"400"},label:"Select",multiple:"","persistent-hint":"",placeholder:"Select State"},null,8,["modelValue"])}}},j={__name:"DemoSelectMenuProps",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>{const o=b;return p(),d(o,{items:l,"menu-props":{transition:"scroll-y-transition"},label:"Label",placeholder:"Select Item"})}}},T={__name:"DemoSelectChips",setup(u){const l=["foo","bar","fizz","buzz"],t=f(["foo","bar","fizz","buzz"]);return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(t),"onUpdate:modelValue":o[0]||(o[0]=n=>v(t)?t.value=n:null),items:l,placeholder:"Select Item",label:"Chips",chips:"",multiple:"","closable-chips":""},null,8,["modelValue"])}}},M={__name:"DemoSelectIcons",setup(u){const l=f("Florida"),t=f("Texas"),m=["Alabama","Alaska","American Samoa","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","District of Columbia","Federated States of Micronesia","Florida","Georgia","Guam"];return(o,c)=>{const n=b;return p(),d(A,null,{default:a(()=>[e(r,{cols:"12"},{default:a(()=>[e(n,{modelValue:S(l),"onUpdate:modelValue":c[0]||(c[0]=_=>v(l)?l.value=_:null),items:m,label:"Select","prepend-icon":"tabler-map","single-line":"",variant:"filled",placeholder:"Select State"},null,8,["modelValue"])]),_:1}),e(r,{cols:"12"},{default:a(()=>[e(n,{modelValue:S(t),"onUpdate:modelValue":c[1]||(c[1]=_=>v(t)?t.value=_:null),items:m,"append-icon":"tabler-map",label:"Select","single-line":"",variant:"filled",placeholder:"Select State"},null,8,["modelValue"])]),_:1})]),_:1})}}},U={__name:"DemoSelectCustomTextAndValue",setup(u){const l=f({state:"Florida",abbr:"FL"}),t=[{state:"Florida",abbr:"FL"},{state:"Georgia",abbr:"GA"},{state:"Nebraska",abbr:"NE"},{state:"California",abbr:"CA"},{state:"New York",abbr:"NY"}];return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(l),"onUpdate:modelValue":o[0]||(o[0]=n=>v(l)?l.value=n:null),hint:`${S(l).state}, ${S(l).abbr}`,items:t,"item-title":"state","item-value":"abbr",label:"Select","persistent-hint":"","return-object":"","single-line":"",placeholder:"Select State"},null,8,["modelValue","hint"])}}},R={__name:"DemoSelectVariant",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>(p(),d(A,null,{default:a(()=>[e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Outlined",placeholder:"Select Item"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Filled",placeholder:"Select Item",variant:"filled"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Solo",placeholder:"Select Item",variant:"solo"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Plain",placeholder:"Select Item",variant:"plain"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Underlined",variant:"underlined",placeholder:"Select Item"})]),_:1})]),_:1}))}},H={__name:"DemoSelectDensity",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>{const o=b;return p(),d(o,{items:l,label:"Density",density:"compact",placeholder:"Select Item"})}}},L={__name:"DemoSelectBasic",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>{const o=b;return p(),d(o,{items:l,label:"Standard",placeholder:"Select Item"})}}},P={ts:`<script lang="ts" setup>
