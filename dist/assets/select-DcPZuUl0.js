import{_ as b}from"./AppSelect-BxRR6mWi.js";import{r as f,o as p,f as d,e as a,b as e,d as s,t as D,aB as v,k as S,dj as I,dk as B,a_ as w,aY as x,aZ as O,q as i}from"./index-DnalRABH.js";import{V as k}from"./VChip-CpxOBTKQ.js";import{V as y}from"./VAvatar-ROVWKNGs.js";import{a as r,V as A}from"./VRow-BhY6s8RW.js";import{V}from"./VSelect-IreTNA7n.js";import{_ as G}from"./AppCardCode-Fl6irVim.js";import"./VTextField-LS5Hij0Q.js";import"./autofocus-BZ1G8Tdp.js";import"./VCounter-BaeywMWo.js";import"./VField-CErbHeKH.js";import"./VList-BucpZaOQ.js";import"./ssrBoot-Bhhf6pux.js";import"./VListSubheader-CW8Fdibs.js";import"./VDivider-CZsSEGK3.js";import"./VCheckboxBtn-Bldtd4uA.js";import"./VSelectionControl-DZPcb5Kr.js";import"./vue3-perfect-scrollbar-Ds4IaEwW.js";import"./VCard-CjJDVDMC.js";import"./VCardText-BFXFavra.js";const $={__name:"DemoSelectSelectionSlot",setup(u){const l=[{name:"Sandra Adams",avatar:I},{name:"Ali Connors",avatar:B},{name:"Trevor Hansen",avatar:w},{name:"Tucker Smith",avatar:x},{name:"Britta Holt",avatar:O}],t=f(["Sandra Adams"]);return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(t),"onUpdate:modelValue":o[0]||(o[0]=n=>v(t)?t.value=n:null),items:l,"item-title":"name","item-value":"name",label:"Select Item",placeholder:"Select Item",multiple:"",clearable:"","clear-icon":"tabler-x"},{selection:a(({item:n})=>[e(k,null,{prepend:a(()=>[e(y,{start:"",image:n.raw.avatar},null,8,["image"])]),default:a(()=>[s("span",null,D(n.title),1)]),_:2},1024)]),_:1},8,["modelValue"])}}},j={__name:"DemoSelectMultiple",setup(u){const l=f(["Alabama"]),t=["Alabama","Alaska","American Samoa","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","District of Columbia","Federated States of Micronesia","Florida","Georgia","Guam"];return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(l),"onUpdate:modelValue":o[0]||(o[0]=n=>v(l)?l.value=n:null),items:t,"menu-props":{maxHeight:"400"},label:"Select",multiple:"","persistent-hint":"",placeholder:"Select State"},null,8,["modelValue"])}}},N={__name:"DemoSelectMenuProps",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>{const o=b;return p(),d(o,{items:l,"menu-props":{transition:"scroll-y-transition"},label:"Label",placeholder:"Select Item"})}}},T={__name:"DemoSelectChips",setup(u){const l=["foo","bar","fizz","buzz"],t=f(["foo","bar","fizz","buzz"]);return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(t),"onUpdate:modelValue":o[0]||(o[0]=n=>v(t)?t.value=n:null),items:l,placeholder:"Select Item",label:"Chips",chips:"",multiple:"","closable-chips":""},null,8,["modelValue"])}}},U={__name:"DemoSelectIcons",setup(u){const l=f("Florida"),t=f("Texas"),m=["Alabama","Alaska","American Samoa","Arizona","Arkansas","California","Colorado","Connecticut","Delaware","District of Columbia","Federated States of Micronesia","Florida","Georgia","Guam"];return(o,c)=>{const n=b;return p(),d(A,null,{default:a(()=>[e(r,{cols:"12"},{default:a(()=>[e(n,{modelValue:S(l),"onUpdate:modelValue":c[0]||(c[0]=_=>v(l)?l.value=_:null),items:m,label:"Select","prepend-icon":"tabler-map","single-line":"",variant:"filled",placeholder:"Select State"},null,8,["modelValue"])]),_:1}),e(r,{cols:"12"},{default:a(()=>[e(n,{modelValue:S(t),"onUpdate:modelValue":c[1]||(c[1]=_=>v(t)?t.value=_:null),items:m,"append-icon":"tabler-map",label:"Select","single-line":"",variant:"filled",placeholder:"Select State"},null,8,["modelValue"])]),_:1})]),_:1})}}},M={__name:"DemoSelectCustomTextAndValue",setup(u){const l=f({state:"Florida",abbr:"FL"}),t=[{state:"Florida",abbr:"FL"},{state:"Georgia",abbr:"GA"},{state:"Nebraska",abbr:"NE"},{state:"California",abbr:"CA"},{state:"New York",abbr:"NY"}];return(m,o)=>{const c=b;return p(),d(c,{modelValue:S(l),"onUpdate:modelValue":o[0]||(o[0]=n=>v(l)?l.value=n:null),hint:`${S(l).state}, ${S(l).abbr}`,items:t,"item-title":"state","item-value":"abbr",label:"Select","persistent-hint":"","return-object":"","single-line":"",placeholder:"Select State"},null,8,["modelValue","hint"])}}},R={__name:"DemoSelectVariant",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>(p(),d(A,null,{default:a(()=>[e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Outlined",placeholder:"Select Item"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Filled",placeholder:"Select Item",variant:"filled"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Solo",placeholder:"Select Item",variant:"solo"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Plain",placeholder:"Select Item",variant:"plain"})]),_:1}),e(r,{cols:"12",sm:"6"},{default:a(()=>[e(V,{items:l,label:"Underlined",variant:"underlined",placeholder:"Select Item"})]),_:1})]),_:1}))}},H={__name:"DemoSelectDensity",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>{const o=b;return p(),d(o,{items:l,label:"Density",density:"compact",placeholder:"Select Item"})}}},L={__name:"DemoSelectBasic",setup(u){const l=["Foo","Bar","Fizz","Buzz"];return(t,m)=>{const o=b;return p(),d(o,{items:l,label:"Standard",placeholder:"Select Item"})}}},Y={ts:`<script lang="ts" setup>
