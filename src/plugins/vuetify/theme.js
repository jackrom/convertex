...
const theme = {
  ...
  themes: {
    light: {
      dark: false,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-lightThemePrimaryColor`) || '#DB7E3A',
        'on-primary': '#fff',
        'secondary': '#2d3455',
        'on-secondary': '#fff',
        'success': '#28C76F',
    ...
    dark: {
      dark: true,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#477130',
        'on-primary': '#fff',
        'secondary': '#5ceaea',
        'on-secondary': '#fff',
        'success': '#28C76F',
