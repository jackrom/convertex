...
const informeSocietarioGerente = computed( () => {
  return informesocietario.value.md_informe_gerente?.replace('{{ lugaryfechaaprobaciongerente }}', informesocietario.value.lugaryfechaaprobaciongerente)
    .replace('{{ nombregerente }}', informesocietario.value.nombreapellidosgerente)
...
const handleInformeSocietarioGerenteChange = newValue => {
  informesocietario.value.md_informe_gerente = newValue
}
  ...
  <VContainer>
    <VRow>
      <VCol cols="12" md="12" class="ckeditor-container">
        <Ckeditor
          v-model="informeSocietarioGerente"
          :editor="editor"
          @input="onEditorBlur"
          @blur="onEditorBlur"
          @update:modelValue="handleInformeSocietarioGerenteChange"
        />
      </VCol>
    </VRow>
  </VContainer>
